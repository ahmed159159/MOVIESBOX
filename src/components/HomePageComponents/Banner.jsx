      ...
      <div className="absolute top-0 left-0 w-full z-40 px-4 py-4 md:px-6 lg:px-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            >
              <div className="rounded-full overflow-hidden w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 shadow-xl hover:scale-110 transition-all duration-300">
                <img
                  src={logo}
                  alt="Logo"
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            <Link
              to="/watchlist"
              className="relative text-white/90 hover:text-white text-sm font-medium transition-all duration-300 px-4 py-2 rounded-full hover:bg-white/10 hover:scale-105 group"
            >
