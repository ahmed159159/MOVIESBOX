      ...
      <div className="flex items-center justify-between bg-ultra-black px-4 py-4 md:px-6 lg:px-10">
        ...
        <div className="flex items-center">
          <Link to="/" className="transform hover:scale-110 transition-all duration-300 group">
            <div className="rounded-full overflow-hidden shadow-xl group-hover:scale-110 transition-all duration-300">
              <img
                src={logo}
                alt="Logo"
        ...
        <div className="flex items-center bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:border-white/40 transition-all duration-300 group">
          ...
          <button
            ...
            text-white w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center 
            text-lg md:text-xl transition-all duration-300 hover:scale-105 shadow-lg mr-1 group"
        ...
        <div className="md:hidden">
          <button
            ...
            hover:bg-white/20 hover:border-white/40 hover:scale-110 transition-all duration-300 
